    ...
    methods: {
     ...
     data() {
        ...
        mounted() { 
            ...
            http.getJSON("https://api.resrobot.se/v2/location.nearbystops?key=808aabc0-1955-4159-b21c-46b52d70dce1&originCoordLat="+lat+"&originCoordLong="+long+"&maxNo="+num+"&format=json").then(result => {
